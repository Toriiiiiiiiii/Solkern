...
void exception_handler(regs_t* regs) {
    ...
    vga_puts("\n  [eip: ");
    vga_setccol( vga_col(VGA_LIGHT_CYAN, VGA_BLACK) );
    vga_nout(regs->eip, 16);
    vga_setccol( vga_col(VGA_CYAN, VGA_BLACK) );
    vga_puts("] [ebp: ");
    vga_setccol( vga_col(VGA_LIGHT_CYAN, VGA_BLACK) );
    vga_nout(regs->ebp, 16);
    vga_setccol( vga_col(VGA_CYAN, VGA_BLACK) );
    vga_puts("] [esp: ");
    vga_setccol( vga_col(VGA_LIGHT_CYAN, VGA_BLACK) );
    vga_nout(regs->esp, 16);
    vga_setccol( vga_col(VGA_CYAN, VGA_BLACK) );
    vga_puts("]");

    vga_puts("\n  [eax: ");
    vga_setccol( vga_col(VGA_LIGHT_CYAN, VGA_BLACK) );
    vga_nout(regs->eax, 16);
    vga_setccol( vga_col(VGA_CYAN, VGA_BLACK) );
    vga_puts("] [ecx: ");
    vga_setccol( vga_col(VGA_LIGHT_CYAN, VGA_BLACK) );
    vga_nout(regs->ecx, 16);
    vga_setccol( vga_col(VGA_CYAN, VGA_BLACK) );
    vga_puts("] [edx: ");
    vga_setccol( vga_col(VGA_LIGHT_CYAN, VGA_BLACK) );
    vga_nout(regs->edx, 16);
    vga_setccol( vga_col(VGA_CYAN, VGA_BLACK) );
    vga_puts("]");

    vga_puts("\n  [ebx: ");
    vga_setccol( vga_col(VGA_LIGHT_CYAN, VGA_BLACK) );
    vga_nout(regs->ebx, 16);
    vga_setccol( vga_col(VGA_CYAN, VGA_BLACK) );
    vga_puts("] [esi: ");
    vga_setccol( vga_col(VGA_LIGHT_CYAN, VGA_BLACK) );
    vga_nout(regs->esi, 16);
    vga_setccol( vga_col(VGA_CYAN, VGA_BLACK) );
    vga_puts("] [edi: ");
    vga_setccol( vga_col(VGA_LIGHT_CYAN, VGA_BLACK) );
    vga_nout(regs->edi, 16);
    vga_setccol( vga_col(VGA_CYAN, VGA_BLACK) );
    vga_puts("]\n\n");
